...
for (file in all_files) {
  ...
  png(paste0("Plots/RDP/ShuffledCountsTHistograms(", name, "-ttest).png"), width=7500, height=3500, res = 300)
  ...
  png(paste0("Plots/RDP/ShuffledCountsTHistograms(", name, "-Wilcoxon).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/RDP/ShuffledCountsTHistograms(", name, "-DESeq2).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/RDP/ShuffledCountsTHistograms(", name, "-edgeR).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
...
#     }
#   }
#   png(paste0("Plots/dada2/ShuffledCountsTHistograms(", name, "-ttest).png"), width=7500, height=3500, res = 300)
#   print(combined_plots + plot_layout(ncol = 15))
#   dev.off()
#
#   combined_plots<-NULL
...
#     }
#   }
#   png(paste0("Plots/dada2/ShuffledCountsTHistograms(", name, "-Wilcoxon).png"), width=7500, height=3500, res = 300)
#   print(combined_plots + plot_layout(ncol = 15))
#   dev.off()
#
#   combined_plots<-NULL
...
#     }
#   }
#   png(paste0("Plots/dada2/ShuffledCountsTHistograms(", name, "-DESeq2).png"), width=7500, height=3500, res = 300)
#   print(combined_plots + plot_layout(ncol = 15))
#   dev.off()
#
#   combined_plots<-NULL
...
#     }
#   }
#   png(paste0("Plots/dada2/ShuffledCountsTHistograms(", name, "-edgeR).png"), width=7500, height=3500, res = 300)
#   print(combined_plots + plot_layout(ncol = 15))
#   dev.off()
#
# }
...
for (file in all_files) {
  ...
  png(paste0("Plots/WGS/ShuffledCountsTHistograms(", name, "-ttest).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/WGS/ShuffledCountsTHistograms(", name, "-Wilcoxon).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/WGS/ShuffledCountsTHistograms(", name, "-DESeq2).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/WGS/ShuffledCountsTHistograms(", name, "-edgeR).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
