...
# Function to make boxplot of fraction of significant counts
...
# Fraction of significant results for each method
...
p<-makePlot(fractionT, "RDP", "Assal", "Shuffle counts in sample")
