...
for (file in all_files) {
  ...
  png(paste0("Plots/RDP/ShuffledInTaxonHistograms(", name, "-ttest).png"), width=7500, height=3500, res = 300)
  ...
  png(paste0("Plots/RDP/ShuffledInTaxonHistograms(", name, "-Wilcoxon).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/RDP/ShuffledInTaxonHistograms(", name, "-DESeq2).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/RDP/ShuffledInTaxonHistograms(", name, "-edgeR).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
...
for (file in all_files) {
  ...
  png(paste0("Plots/dada2/ShuffledInTaxonHistograms(", name, "-ttest).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/dada2/ShuffledInTaxonHistograms(", name, "-Wilcoxon).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/dada2/ShuffledInTaxonHistograms(", name, "-DESeq2).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/dada2/ShuffledInTaxonHistograms(", name, "-edgeR).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
...
for (file in all_files) {
  ...
  png(paste0("Plots/WGS/ShuffledInTaxonHistograms(", name, "-ttest).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/WGS/ShuffledInTaxonHistograms(", name, "-Wilcoxon).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/WGS/ShuffledInTaxonHistograms(", name, "-DESeq2).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/WGS/ShuffledInTaxonHistograms(", name, "-edgeR).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
