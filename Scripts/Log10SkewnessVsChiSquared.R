...
png(paste0("Plots/RDP/Log10SkewVsChi(RDP).png"), width=4800, height=3600, res = 300)
...
png(paste0("Plots/dada2/Log10SkewVsChi(dada2).png"), width=4800, height=3600, res = 300)
...
png(paste0("Plots/WGS/Log10SkewVsChi(WGS).png"), width=4800, height=2400, res = 300)
