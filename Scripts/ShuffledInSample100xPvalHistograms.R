#shuffle counts within each sample 100x and test all pval distribution
rm(list = ls())
...
for (file in all_files) {
  ...
  png(paste0("Plots/RDP/ShuffledInSampleHistograms(", name, "-ttest).png"), width=7500, height=3500, res = 300)
  ...
  png(paste0("Plots/RDP/ShuffledInSampleHistograms(", name, "-Wilcoxon).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/RDP/ShuffledInSampleHistograms(", name, "-DESeq2).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/RDP/ShuffledInSampleHistograms(", name, "-edgeR).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
...
for (file in all_files) {
  ...
  png(paste0("Plots/dada2/ShuffledInSampleHistograms(", name, "-ttest).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/dada2/ShuffledInSampleHistograms(", name, "-Wilcoxon).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/dada2/ShuffledInSampleHistograms(", name, "-DESeq2).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/dada2/ShuffledInSampleHistograms(", name, "-edgeR).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
...
for (file in all_files) {
  ...
  png(paste0("Plots/WGS/ShuffledInSampleHistograms(", name, "-ttest).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/WGS/ShuffledInSampleHistograms(", name, "-Wilcoxon).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/WGS/ShuffledInSampleHistograms(", name, "-DESeq2).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
  ...
  png(paste0("Plots/WGS/ShuffledInSampleHistograms(", name, "-edgeR).png"), width=7500, height=3500, res = 300)
  print(combined_plots + plot_layout(ncol = 15))
  dev.off()
